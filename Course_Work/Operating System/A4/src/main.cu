...
#define SUPERBLOCK_SIZE 4096 //4096 / 8 = 512 entries in Super Block
#define FCB_SIZE 32 //32 bytes per FCB, 32 bytes per block.
#define FCB_ENTRIES 1024 //We can have 1024 files.
#define VOLUME_SIZE 1085440 //4096 (bit-map)+32768(FCB)+1048576 (Contents of the file)
#define STORAGE_BLOCK_SIZE 32

#define MAX_FILENAME_SIZE 20
#define MAX_FILE_NUM 1024
#define MAX_FILE_SIZE 1048576 //Total file size = 1MB (32768 Blocks)
//Start address of the first file. 4096(Bit map)+32768 (FCB Table)
